  ...
  void initState() {
    ...
    _audioSyncTicker = createTicker((elapsed) {
      if (widget.dawState.isPlaying) {
        ...
        logToSupabase("DEBUG: timeline_canvas.dart createTicker high-res time fetch. foundTime = ${foundTime}");
        ...
        for (String stemName in widget.dawState.stemSources.keys) {
          ...
          logToSupabase("DEBUG: timeline_canvas.dart Update Audio Stem: ${stemName}, value: ${widget.dawState.channelLevels[stemName]?.value} foundTime");
        }
        // -----------------------------
